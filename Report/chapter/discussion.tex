...
Some of the functions are written with tail recursion so stack overflow could be avoided. But it is not all function that are written with tail recursion. Some functions \todo{indsæt eksempel} are written with classic recursion. This is done because it is not worthwhile to write them as tail recursive, because they are so simple.
